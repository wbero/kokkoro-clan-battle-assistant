...
class ClockDebugCsv(private val writer: Writer, header: String) : Closeable {
    ...
    companion object {
        const val FRAME_HEADER = "frameId,wallMs,gate,recognitionRaw,recognitionOk,recognitionConfidence,recognitionReason,filterAccepted,filterTime,filterReason,filterSource,dropped,ubBannerActive,ubBannerRawPresent,ubBannerScore,ubBannerColorScore,ubBannerLeftScore,ubBannerRightScore,roleUbFlashRole,roleUbFlashRawRole,roleUbFlashScore,roleUbFlashMargin"
